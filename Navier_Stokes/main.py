...
def shape_optimization(target):
    ...
    mesh = Mesh('Mesh/pipe.msh')

    # Setup PDE constraint
    Q = FeControlSpace(mesh)
    # Fix boundaries: 10 = inlet, 11 = outlet, 14 = top-bottom
    inner = ElasticityInnerProduct(Q, fixed_bids=[10,11,14])
...
if __name__ == "__main__":
    ...
    The default settings correspond to reproducing Fig 8b of the paper.
    """
